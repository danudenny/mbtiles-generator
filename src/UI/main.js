...
$(function () {
    ...
    var sources = {
        ...
        'div-5': '',
        'Geoserver WMTS Indonesia':
            'https://geoserver.api.kolti.net/geoserver/gwc/service/wmts/gwc/service/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=Koltiva-Internal%3Agis_int_idn_raster&TILEMATRIXSET=EPSG:900913&TILEMATRIX=EPSG:900913:{z}&TILEROW={y}&TILECOL={x}&FORMAT=image%2Fpng',
        'Geoserver WMTS Vietnam':
            'https://geoserver.api.kolti.net/geoserver/gwc/service/wmts/gwc/service/wmts?SERVICE=WMTS&REQUEST=GetTile&VERSION=1.0.0&LAYER=Koltiva-Internal%3Agis_int_vnm_raster&TILEMATRIXSET=EPSG:900913&TILEMATRIX=EPSG:900913:{z}&TILEROW={y}&TILECOL={x}&FORMAT=image%2Fpng',
    };
    ...
    function uploadGeojson() {
        $('#current-view-button').click(function () {
            var input = document.getElementById('file-input-geojson');
            input.click();
                ...
                reader.onload = function (e) {
                    ...
                    data.features.forEach(function (feature) {
                        if (feature.geometry.type === 'Polygon') {
                            feature.geometry.coordinates[0].forEach(function (
                                coord
                            ) {
                                bounds.extend(coord);
                                draw.add({
    ...
    function showTilePopup(e) {
        ...
        content +=
            'Lat, Lng<br/><b>' + e.lngLat.lat + ', ' + e.lngLat.lng + '</b>';
    ...
    function clearMap() {
        $('#clear-map-button').click(function () {
            ...
            // zoom out to the initial location
            map.flyTo({
                center: [119.5228984, -2.2935086],
                zoom: 4,
            });
